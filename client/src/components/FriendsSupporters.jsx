    ...
    <section className="bg-white py-20" aria-label="Friends and Supporters Logos">
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-10 items-center mb-20">
          <a href="http://www.nolimitwetsuits.co.uk/" target="_blank" rel="noopener noreferrer" onClick={() => trackClick("No Limit Wetsuits")}> <img src="/logos/nolimit.png" alt="No Limit Wetsuits" className="h-44 max-w-[160px] p-4 mx-auto grayscale hover:grayscale-0 hover:scale-105 transform transition duration-300" /> </a>
          <a href="https://www.lostshore.com/" target="_blank" rel="noopener noreferrer" onClick={() => trackClick("Lost Shore Surf Resort")}> <img src="/logos/lostshore.png" alt="Lost Shore Surf Resort" className="h-44 max-w-[160px] p-4 mx-auto grayscale hover:grayscale-0 hover:scale-105 transform transition duration-300" /> </a>
          <a href="https://www.facebook.com/PegSurfCoaching/?locale=en_GB" target="_blank" rel="noopener noreferrer" onClick={() => trackClick("Pegleg Surf Coaching")}> <img src="/logos/pegleg.png" alt="Pegleg Surf Coaching" className="h-44 max-w-[160px] p-4 mx-auto grayscale hover:grayscale-0 hover:scale-105 transform transition duration-300" /> </a>
          <a href="https://shop.srh.com/" target="_blank" rel="noopener noreferrer" onClick={() => trackClick("SRHproductions")}> <img src="/logos/srh.png" alt="SRHproductions" className="h-44 max-w-[160px] p-4 mx-auto grayscale hover:grayscale-0 hover:scale-105 transform transition duration-300" /> </a>
          <a href="https://www.thesurfskateacademy.com/" target="_blank" rel="noopener noreferrer" onClick={() => trackClick("The SurfSkate Academy")}> <img src="/logos/surfskate.png" alt="The SurfSkate Academy" className="h-44 max-w-[160px] p-4 mx-auto grayscale hover:grayscale-0 hover:scale-105 transform transition duration-300" /> </a>
</div>
